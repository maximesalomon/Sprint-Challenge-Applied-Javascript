...
class TabCard {
  ...
  selectCard(){
    ...
    this.cardElement = this.cardElement.setAttribute('style', 'display:flex');
  }
...
// const testSelectorAllCards = document.querySelectorAll(`.card[data-tab]`);
// console.log(testSelectorAllCards);